...
import glob
folders = ('non-vehicles\Extras\*.png', 'non-vehicles\GTI\*.png', 'vehicles\GTI_Far\*.png', 'vehicles\GTI_Left\*.png',
           'vehicles\GTI_MiddleClose\*.png', 'vehicles\GTI_Right\*.png', 'vehicles\KITTI_extracted\*.png')
images = []
